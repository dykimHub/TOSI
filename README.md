...
<table>
  <tr>
    <th style="text-align: center;">동화 엔딩</th>
    <th style="text-align: center;">등장인물과의 채팅</th>
  </tr>
  <tr>
    <td>![taleend](/uploads/1dd2c38633b5db9feb7e8143a823b600/taleend.gif)</td>
    <td>![chat](/uploads/32eeb133944be0c7c068feef3401745e/chat.gif)</td>
  </tr>
  <tr>
    <td>- 동화 구연이 끝날 때마다 등장인물 중 한 명이 랜덤 메세지를 보냅니다. <br> - 원하는 등장인물에게 채팅을 걸 수 있습니다. 선택한 어린이의 이름으로 채팅방이 형성됩니다. </td>
    <td>- 선택한 등장인물이 입장했다는 메세지가 뜹니다. 해당 등장인물에게 5번의 대답을 들을 수 있습니다.  <br> - 메세지가 추가될 때마다 스크롤을 최하단으로 내려 최신 메세지를 바로 볼 수 있도록 합니다. <br> - 5번의 대답이 끝나면 등장인물이 작별 인사를 보내고 대화를 종료합니다. 더 이상 채팅을 입력할 수 없고 나가기를 눌러 동화 목록 페이지로 갈 수 있습니다. </td>
  </tr>
