    ...
    <div id="app" class="talelistContainer">
        ...
        <div class="twoContainer">
                ...
                <div class="info" v-if="!customTaleStore.customTaleText.gptMessage">
                    <div class="inputgroup">
                        <div class="input">
                            ...
                            <select class="form-select" aria-label="Default select example" v-model="selectedChild">
                                <option value="" disabled selected>주인공을 선택해보세요</option>
                                <option
            ...
            <div class="book-column">
                <div class="book">
                    <img v-if="customTaleStore.customTaleImage" :src="customTaleStore.customTaleImage" />
