...
const postLogin = function(userInfo) {
  ...
  const getPasswordCheck = function(password){
    axios.post(`${User_API}/password-check`, {password}, { withCredentials: true })
    .then((response)=>{
  ...
  return { postUser, getUser, userInfo, updateUser, deleteUser, getUserSearch, searchResult, 
    postLogin, loginUserId, getLogout, getPasswordCheck, getChildrenList, childrenList, isLoggedIn};
